...
Telescope::Telescope() {
  ...
  if (AXIS1_ENABLE_PIN >= 0 && AXIS1_ENABLE_PIN <= 255 && AXIS1_DISABLE_PINS != ON) { pinMode(AXIS1_ENABLE_PIN, OUTPUT); digitalWrite(AXIS1_ENABLE_PIN, !AXIS1_ENABLE_STATE); }
  if (AXIS2_ENABLE_PIN >= 0 && AXIS2_ENABLE_PIN <= 255 && AXIS2_DISABLE_PINS != ON) { pinMode(AXIS2_ENABLE_PIN, OUTPUT); digitalWrite(AXIS2_ENABLE_PIN, !AXIS2_ENABLE_STATE); }
  if (AXIS3_ENABLE_PIN >= 0 && AXIS3_ENABLE_PIN <= 255 && AXIS3_DISABLE_PINS != ON) { pinMode(AXIS3_ENABLE_PIN, OUTPUT); digitalWrite(AXIS3_ENABLE_PIN, !AXIS3_ENABLE_STATE); }
  if (AXIS4_ENABLE_PIN >= 0 && AXIS4_ENABLE_PIN <= 255 && AXIS4_DISABLE_PINS != ON) { pinMode(AXIS4_ENABLE_PIN, OUTPUT); digitalWrite(AXIS4_ENABLE_PIN, !AXIS4_ENABLE_STATE); }
  if (AXIS5_ENABLE_PIN >= 0 && AXIS5_ENABLE_PIN <= 255 && AXIS5_DISABLE_PINS != ON) { pinMode(AXIS5_ENABLE_PIN, OUTPUT); digitalWrite(AXIS5_ENABLE_PIN, !AXIS5_ENABLE_STATE); }
  if (AXIS6_ENABLE_PIN >= 0 && AXIS6_ENABLE_PIN <= 255 && AXIS6_DISABLE_PINS != ON) { pinMode(AXIS6_ENABLE_PIN, OUTPUT); digitalWrite(AXIS6_ENABLE_PIN, !AXIS6_ENABLE_STATE); }
  if (AXIS7_ENABLE_PIN >= 0 && AXIS7_ENABLE_PIN <= 255 && AXIS7_DISABLE_PINS != ON) { pinMode(AXIS7_ENABLE_PIN, OUTPUT); digitalWrite(AXIS7_ENABLE_PIN, !AXIS7_ENABLE_STATE); }
  if (AXIS8_ENABLE_PIN >= 0 && AXIS8_ENABLE_PIN <= 255 && AXIS8_DISABLE_PINS != ON) { pinMode(AXIS8_ENABLE_PIN, OUTPUT); digitalWrite(AXIS8_ENABLE_PIN, !AXIS8_ENABLE_STATE); }
  if (AXIS9_ENABLE_PIN >= 0 && AXIS9_ENABLE_PIN <= 255 && AXIS9_DISABLE_PINS != ON) { pinMode(AXIS9_ENABLE_PIN, OUTPUT); digitalWrite(AXIS9_ENABLE_PIN, !AXIS9_ENABLE_STATE); }
